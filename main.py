...
API_ID = int(os.environ.get("API_ID", 25377714))
API_HASH = os.environ.get("API_HASH", "ffc0d0e9d25947127bbf344e83a43f8c")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8232406162:AAFV5YDemQmMvFbGl6wZ8HOIdY4O2hm4MsA")
